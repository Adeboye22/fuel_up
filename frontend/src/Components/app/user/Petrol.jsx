  ...
  return (
    <div className='pt-8'>
      ...
      <form action="" onSubmit={handleSubmit} className='flex flex-col place-items-center gap-2'>
        ...
        <p className='text-gray ml-36'> Amount: ₦ <input type="text" value={selectedAmount} readOnly className='text-lime bg-transparent outline-none'/></p>
        {/* Display the service charge by 8% */}
        <p className='text-gray ml-36'>Service Charge <span className='text-lime'>(8%)</span>: ₦ <input type="text" value={charge} readOnly className='text-lime outline-none'/></p>
        {/* Display the total amount */}
        <p className='text-gray pt-4 ml-36'>Total: ₦<input type="text" value={total} readOnly className='text-lime outline-none'/></p>
