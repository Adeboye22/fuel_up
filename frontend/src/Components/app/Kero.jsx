...
const Kero = () => {
  ...
  return (
    <div className='pt-8'>
      <h1 className='text-lime text-lg font-bold text-center pb-4'>Kerosene</h1>
      <form action="" onSubmit={handleSubmit} className='flex flex-col place-items-center gap-8'>
        ...
        <button type="submit" className='border border-lime rounded outline-dashed outline-2 outline-lime outline-offset-2 w-24'>Order</button>
      </form>
    </div>
  )
}
