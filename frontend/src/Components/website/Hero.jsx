...
const Hero = () => {
  ...
  return (
      <div className='sm:my-4 sm:h-full sm:px-8 justify-center w-full h-3/4 px-44 my-40 sm:background-altBlack'>
        <h1 className='font-bold text-3xl text-center'>Efficient fuel dispatching made simple:</h1>
        <p className='my-4 text-lg text-center'>Streamlining your operations with ease.</p>
