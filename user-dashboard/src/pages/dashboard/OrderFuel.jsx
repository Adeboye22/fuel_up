                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <input
                        type="number"
                        value={quantity}
                        onChange={(e) => setQuantity(Math.max(5, Number.parseInt(e.target.value) || 5))}
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                ...
                <div className="space-y-3">
                  {user?.addresses?.map((location) => (
                    <div
                      ...
                      className={`p-4 rounded-lg border cursor-pointer transition-all ${
                        selectedLocation === location._id ? styles.cardSelected : styles.cardUnselected
                      }`}
                    >
                      <div className="flex items-center">
                        <div
                          className={`p-2 rounded-lg mr-3 ${selectedLocation === location._id ? styles.iconBg : styles.iconInactiveBg}`}
                        >
              ...
              <div className={`p-4 ${styles.summaryBox} rounded-lg mb-6 flex items-start`}>
                ...
                <p className={`text-sm ${isLightMode ? "text-gray-700" : "text-gray-300"}`}>
                  Delivery is available 7 days a week during standard hours (8AM-8PM). Delivery will be scheduled within
          ...
          {step === 3 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div
                    ...
                    className={`p-4 rounded-lg border cursor-pointer transition-all ${
                      paymentMethod === "paystack" ? styles.cardSelected : styles.cardUnselected
                    }`}
                  >
                    <div className="flex items-center">
                      <div
                        className={`p-2 rounded-lg mr-3 ${paymentMethod === "paystack" ? styles.iconBg : styles.iconInactiveBg}`}
                      >
              ...
              <div className={`p-4 ${styles.summaryBox} rounded-lg mb-6 flex items-start`}>
                <FaInfoCircle className="text-blue-500 mt-1 mr-3" />
                <p className={`text-sm ${isLightMode ? "text-gray-700" : "text-gray-300"}`}>
                  You'll be redirected to our secure payment gateway (Paystack) to complete your payment. Your payment
